...
class EDDGridFromEtopoTests {
  ...
  void testSchema(boolean generateCroissantSchema) throws Throwable {
    ...
    EDDGrid eddGrid = (EDDGrid) EDDTestDataset.getetopo360();
    tName =
    ...
    expected =
        "{\n"
            ...
            + "  {\n"
            + "    \"@type\": \"cr:FileObject\",\n"
            + "    \"@id\": \"etopo1_ice_g_i2.bin\",\n"
            + "    \"contentSize\": \"466624802 B\",\n"
            + "    \"contentUrl\": \"http://localhost:8080/erddap/files/etopo360/etopo1_ice_g_i2.bin\",\n"
            ...
            + "    \"includes\": \"http://localhost:8080/erddap/files/etopo360/*.*\"\n"
            + "  }\n"
            + "  ],\n"
            + "  \"recordSet\": [\n"
            + "    {\n"
            ...
            + "data_source=NOAA NGDC ETOPO1\\n"
            + "drawLandMask=under\\n"
            + "Easternmost_Easting=360.0\\n"
            + "geospatial_lat_max=90.0\\n"
            + "geospatial_lat_min=-90.0\\n"
            + "geospatial_lat_resolution=0.016666666666666666\\n"
            + "geospatial_lat_units=degrees_north\\n"
            + "geospatial_lon_max=360.0\\n"
            + "geospatial_lon_min=0.0\\n"
            + "geospatial_lon_resolution=0.016666666666666666\\n"
            + "geospatial_lon_units=degrees_east\\n"
            + "history=2011-03-14 Downloaded https://www.ngdc.noaa.gov/mgg/global/relief/ETOPO1/data/ice_surface/grid_registered/binary/etopo1_ice_g_i2.zip\\n"
            + "id=etopo360\\n"
            + "infoUrl=https://www.ngdc.noaa.gov/mgg/global/global.html\\n"
            ...
            + "  \"url\": \"http://localhost:8080/erddap/griddap/etopo360.html\",\n"
            ...
            + "    \"@type\": \"Organization\",\n"
            + "    \"name\": \"NOAA NGDC\",\n"
            + "    \"email\": \"Barry.Eakins@noaa.gov \",\n"
            + "    \"sameAs\": \"https://www.ngdc.noaa.gov/mgg/global/global.html\"\n"
            + "  },\n"
            + "  \"identifier\": \"gov.noaa.pfeg.coastwatch/etopo360\",\n"
            + "  \"spatialCoverage\": {\n"
            + "    \"@type\": \"Place\",\n"
            + "    \"geo\": {\n"
            + "      \"@type\": \"GeoShape\",\n"
